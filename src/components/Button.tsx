...
const Button: FC<Props> = ({
  ...
  <button
    className={clsx(
      'rounded-lg transition-all duration-100 flex flex-wrap items-center justify-center font-bold outline-none',
      variant === 'primary' &&
      ...
      variant === 'tertiary' &&
        'bg-transparent text-orange-700 hover:text-orange-900 hover:underline active:text-orange-700 focus:underline',
